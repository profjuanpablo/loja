<div class="container theme-showcase" role="main">
	<div class="page-header">
        <h1>Cadastrar Situação para Contato</h1>
	</div>
	<div class="row">
	...
	<form name="adm_cad_sit_contato" class="form-horizontal" method="POST" action="administrativo/processa/adm_proc_cad_sit_contato.php" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<input type="submit" class="btn btn-success" value="Cadastrar" onclick="return val_adm_cad_sit_contato()">
			</div>
		</div>
	</form>
</div>