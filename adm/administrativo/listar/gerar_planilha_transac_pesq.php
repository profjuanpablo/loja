...
<html lang="pt-br">
	...
	<body>
		...
		$result_transacoes = "SELECT id, transacao_cod, status_transacao, nome, data_transacao FROM transacoes WHERE created BETWEEN '$data_inicio' AND '$data_final' ORDER BY id DESC";
