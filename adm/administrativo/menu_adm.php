			...
			<ul class="nav navbar-nav">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="administrativo.php?link=63">Mensagens de Contato</a></li>
						<li><a href="administrativo.php?link=75">Situação da Mensagem</a></li>
					</ul>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="administrativo.php?link=79">Situação do Comentário</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Carrousel<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="administrativo.php?link=67">Listar Carrousel</a></li>
						<li><a href="administrativo.php?link=71">Situação do Carrousel</a></li>
					</ul>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="administrativo.php?link=83">Listar Transaçoes</a></li>
						<li><a href="administrativo.php?link=87">Listar Carrinhos</a></li>
					</ul>
				</li>
			</ul>
