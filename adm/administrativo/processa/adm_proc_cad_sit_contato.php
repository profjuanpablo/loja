<?php
	...
	if(empty($_POST['nome'])){
		$url = pg.'/adm/administrativo.php?link=77'; 
		echo "
	...
	if($salvar_dados_bd == 1){
		...
		$result_sit_contato = "INSERT INTO situacoes_contatos (nome, cor, created) VALUES ('$nome', '$cor', NOW())";
		...
		<html lang="pt-br">
			...
			<body> <?php
				if(mysqli_affected_rows($conn) != 0){
					$url = pg.'/adm/administrativo.php?link=75'; 
					echo "
						<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=$url'>
						<script type=\"text/javascript\">
							alert(\"Situação para mensagem de contato cadastrado com Sucesso.\");
						</script>
					";	
				}else{
					$url = pg.'/adm/administrativo.php?link=75'; 
					echo "
						<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=$url'>
						<script type=\"text/javascript\">
							alert(\"Situação para mensagem de contato não foi cadastrado com Sucesso.\");
						</script>
					";	
				}?>
			</body>
